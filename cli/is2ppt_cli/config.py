...
from .identity import CONFIG_DIR_NAME, ENV_PREFIX
...
ENV_MAP = {
    "base_url": _env_name(ENV_PREFIX, "BASE_URL"),
    "access_code": _env_name(ENV_PREFIX, "ACCESS_CODE"),
    "poll_interval": _env_name(ENV_PREFIX, "POLL_INTERVAL"),
    "request_timeout": _env_name(ENV_PREFIX, "REQUEST_TIMEOUT"),
    "continue_on_error": _env_name(ENV_PREFIX, "CONTINUE_ON_ERROR"),
}
