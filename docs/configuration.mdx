...
is2ppt explicitly packages the LazyLLM online provider SDKs for domestic vendors:
...
Some optional OCR and image inpainting diagnostics use Baidu Cloud APIs. Apply for an [IAM API Key](https://console.bce.baidu.com/iam/#/iam/apikey/list) from Baidu Cloud if you need those tests:
