---
title: "Quick Start"
description: "Try the demo or deploy is2ppt locally"
---

## Project Entry

Use the repository as the current project entry: [PuPuSama/IS2PPT-DEMO](https://github.com/PuPuSama/IS2PPT-DEMO).
