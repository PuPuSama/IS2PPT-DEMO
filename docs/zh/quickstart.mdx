...
当前项目入口为 GitHub 仓库：[is2ppt/is2ppt](https://github.com/is2ppt/is2ppt)。
...
curl -O https://raw.githubusercontent.com/is2ppt/is2ppt/main/docker-compose.prod.yml && \
curl -O https://raw.githubusercontent.com/is2ppt/is2ppt/main/.env.example && \
cp .env.example .env
```
