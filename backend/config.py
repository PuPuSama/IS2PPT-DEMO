...
class Config:
    ...
    # 网络搜索配置（联网调研增强大纲生成，见 docs/PRD-web-research-clarify-outline.md）
    SEARCH_PROVIDER = os.getenv('SEARCH_PROVIDER', 'tavily')  # 可选: tavily（后续 searxng/bocha）
    ...
    TAVILY_SEARCH_DEPTH = os.getenv('TAVILY_SEARCH_DEPTH', 'advanced')  # basic | advanced
